...
but it's just a way of describing the pre-packaged user interface and experience that Web3Auth has ready for you. The idea here is to integrating
...
To get a client id for your project, please refer to [here](/dashboard-setup/projects-and-analytics).
