...
respectively of the EVM chain you're connecting to. We've initialized them for the ethereum chain for this guide.
...
[examples repository](https://github.com/Web3Auth/web3auth-core-kit-examples/tree/main/mpc-core-kit-web/intrinsic-flow-examples/mpc-core-kit-popup-flow-example).
